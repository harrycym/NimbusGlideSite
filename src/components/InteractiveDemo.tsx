      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="max-w-[700px] mx-auto" data-animate="fade-up" data-delay="150">
          ...
          <div className="flex flex-col items-center gap-4 mt-8">
            ...
            <a
              href="#try-it"
              className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 to-violet-500 rounded-full shadow-[0_2px_12px_rgba(99,102,241,0.25)] hover:shadow-[0_4px_20px_rgba(99,102,241,0.35)] hover:-translate-y-0.5 transition-all"
            >
