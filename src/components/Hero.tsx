      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="max-w-[560px] lg:max-w-none">
          ...
          <div className="flex gap-4 mb-12 flex-wrap" data-animate="fade-up" data-delay="300">
            <a href="#try-it" data-magnetic className="inline-flex items-center gap-2 px-7 py-3.5 text-[0.95rem] font-semibold text-white bg-gradient-to-r from-indigo-500 to-violet-500 rounded-full shadow-[0_2px_12px_rgba(99,102,241,0.25)] hover:shadow-[0_8px_30px_rgba(99,102,241,0.4)] hover:-translate-y-0.5 transition-all">
